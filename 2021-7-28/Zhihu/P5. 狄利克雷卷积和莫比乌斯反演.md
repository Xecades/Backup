#! https://zhuanlan.zhihu.com/p/390895860
![image](https://blog.xecades.xyz/assets/DirichletConvolution-thumbnail.png)
...
[「狄利克雷卷积」和「莫比乌斯反演」 | Xecades 的博客](https://blog.xecades.xyz/articles/DirichletConvolution/ "card")
...
由狄利克雷逆的唯一性，$f*g$ 的狄利克雷逆是唯一的，所以 $(f\ast g)^{-1}=f^{-1}*g^{-1}$.
