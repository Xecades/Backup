...
export async function renderFolderView(items, path, request) {
  ...
  const intro = `<div class="intro markdown-body" style="text-align: left; margin-top: 2rem;">
                    <h2>Hi, I'm Xecades 👋</h2>
                    <p>This is Xecades's OneDrive public directory listing. Feel free to download any files that you find useful. Reach me at: i#xecades.xyz.</p>
                    <p><a href="https://xecades.xyz">Portfolio</a> · <a href="https://blog.xecades.xyz">Blog</a> · <a href="https://github.com/Xecades">GitHub</a></p>
                  </div>`
