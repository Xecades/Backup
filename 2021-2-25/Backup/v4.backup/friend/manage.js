...
for (var i = 0; i < num; i++)
{
    ins.innerHTML += "<a class='friend-card' style='color:#fff; background-color:transparent;' target='_blank' rel='external nofollow noopener noreferrer' href='" + link[arr[i]] + "'><div class='friend-left'><img class='avatar' src='https://cdn.v4.backup.xecades.xyz/image-friend/" + pic[arr[i]] + "' /></div><div class='friend-right'><p class='friend-name'>" + nick[arr[i]] + "</p><div class='friend-tags-wrapper'><p class='tags'><i class='fa fa-hashtag' aria-hidden='true'></i>" + tag[arr[i]] + "</p></div></div></a>";
}