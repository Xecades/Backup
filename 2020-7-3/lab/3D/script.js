...
function draw() {
    ...
    window.ondeviceorientation = function (e) {
        ...
        SX = -col / 100 * e.gamma + col / 2;
        SY = -row / 100 * e.beta + row / 2;
        if (SX != lastSX || SY != lastSY)
            fresh();
        lastSX = SX;
        lastSY = SY;
...
function fresh() {
    ...
    solidLine(0, 0, leftTopX, leftTopY, "#eee", "#555");
    solidLine(0, row, leftTopX, rightBottomY, "#eee", "#555");
    solidLine(col, 0, rightBottomX, leftTopY, "#eee", "#555");
    solidLine(col, row, rightBottomX, rightBottomY, "#eee", "#555");

    solidLine(leftTopX, leftTopY, leftTopX, rightBottomY, "#555", "#555");
    solidLine(leftTopX, leftTopY, rightBottomX, leftTopY, "#555", "#555");
    solidLine(rightBottomX, leftTopY, rightBottomX, rightBottomY, "#555", "#555");
    solidLine(leftTopX, rightBottomY, rightBottomX, rightBottomY, "#555", "#555");
