...
![](https://cdn.xecades.xyz/image/base64-pic1.png)

还是不懂？看个例子吧 (对 `Man` 进行编码)

![](https://cdn.xecades.xyz/image/base64-pic2.png)
...
![](https://cdn.xecades.xyz/image/base64-pic3.png)
...
<a href="https://file.xecades.xyz/Other/Database.txt" class="LinkCard">单词数据库</a>
...
我觉得 iq(智商) 变成 axe(斧子) 的那个不错，比喻生动形象，~~呼吁着人们多读书，就可以一刀九九九级~~
...
(`HID`, `HIE`, `HIS` 那三个太妙了，除开大小写，编码后和原文一样)
