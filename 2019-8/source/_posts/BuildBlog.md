...
　　再输入`npm install hexo -g`安装$hexo$，前面可能会有$3$个$WARN$，不用管。
...
　　打开文件后，可以在右上角选择![按钮](/image/BuildBlog-pic19.png)继续预览编辑。在文件开头有如下几行字:
...
能把自己的一份爱好(我是学信息学竞赛的)弄到自己满意的程度，我完全有脸面也有资格停下来，小憩一下，把初三没看的十余部电影看完，但我不想，我厌烦这种孤独享乐的日子，这样的生活还会有什么价值？我知道，也希望我的读者也一样，像朱光潜所说：朝着抵抗力最大的方向前进！
