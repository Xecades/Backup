...
int main()
{
   ...
   cout<<"87th:\t\t"<<v[87]<<endl;     //索引为87的值 
   cout<<"Last:\t\t"<<v.back()<<endl;  //最后的值 
   cout<<"First:\t\t"<<v.front()<<endl;//第一个值 
   
   cout<<"Use iterator:"<<endl;        //用iterator遍历 
   for(v_i::iterator ite=v.begin();ite<v.end();ite++)
      cout<<*ite<<" ";
   cout<<endl<<"done.";
   return 0;
}
